...
const Products: React.FC = () => {
    const products = [
        ...
        },
        {
            ...
            name: 'Rowing Machine',
            price: 899,
            image: 'https://images.pexels.com/photos/6456005/pexels-photo-6456005.jpeg',
            description: 'Cardio rower with digital display.'
        },
        {
            id: 11,
            name: 'Fitness Gloves',
            price: 29,
            image: 'https://images.pexels.com/photos/1552241/pexels-photo-1552241.jpeg',
            description: 'Anti-slip breathable workout gloves.'
        },
        {
            id: 12,
            name: 'Jump Rope',
        ...
        },
        {
            ...
            description: 'Compact stepper for indoor cardio.'
        },
        {
            id: 14,
            name: 'Smart Scale',
            ...
            description: 'Tracks weight, BMI, body fat %.'
        },
        {
            id: 15,
            name: 'Medicine Ball',
            price: 59,
            image: 'https://images.pexels.com/photos/669577/pexels-photo-669577.jpeg',
            description: 'Durable medicine ball, 4kg.'
        },
        {
            id: 16,
            name: 'Ankle Weights',
            price: 45,
            image: 'https://images.pexels.com/photos/4498576/pexels-photo-4498576.jpeg',
            description: 'Adjustable ankle weights (2kg).'
        },
        {
            id: 17,
            name: 'Balance Board',
            price: 69,
            image: 'https://images.pexels.com/photos/4498601/pexels-photo-4498601.jpeg',
            description: 'For stability & core training.'
        },
        {
            id: 18,
            name: 'Battle Ropes',
            ...
            description: 'Strength + endurance rope training.'
        },
        {
            id: 19,
            name: 'Fitness Tracker',
            price: 149,
            image: 'https://images.pexels.com/photos/6456109/pexels-photo-6456109.jpeg',
            description: 'Smart fitness band with heart rate.'
        },
        {
            id: 20,
            name: 'Spin Bike',
            price: 999,
            image: 'https://images.pexels.com/photos/1954521/pexels-photo-1954521.jpeg',
            description: 'Indoor cycling bike, adjustable seat.'
        }
    ];
