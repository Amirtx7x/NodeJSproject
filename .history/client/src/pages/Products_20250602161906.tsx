...
const Products: React.FC = () => {
    ...
    const products = [
        { id: 1, name: 'Adjustable Dumbbells', price: 299, image: 'https://images.pexels.com/photos/4793222/pexels-photo-4793222.jpeg', description: 'Adjustable dumbbells for strength training.' },
        { id: 2, name: 'Yoga Mat Pro', price: 89, image: 'https://images.pexels.com/photos/8436639/pexels-photo-8436639.jpeg', description: 'Comfortable non-slip yoga mat.' },
        ...
        { id: 5, name: 'Foldable Treadmill', price: 1199, image: 'https://images.pexels.com/photos/4662438/pexels-photo-4662438.jpeg', description: 'Space-saving foldable treadmill.' },
                ...
                {filteredProducts.map((product) => (
                    <div className="product-card" key={product.id}>
                        ...
                        <div className="product-info">
                            ...
                            <button onClick={() => setSelectedProduct({ id: product.id, name: product.name })}>
                                View Product
                            </button>
                        </div>
                    </div>
